    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                "dashboard-posts": path.resolve(process.cwd(), "src/client/entries/dashboard-posts.tsx"),
                "dashboard-post": path.resolve(process.cwd(), "src/client/entries/dashboard-post.tsx"),
                ...
                "admin-reports": path.resolve(process.cwd(), "src/client/entries/admin-reports.tsx"),
                "admin-logs": path.resolve(process.cwd(), "src/client/entries/admin-logs.tsx"),
                "admin-settings": path.resolve(process.cwd(), "src/client/entries/admin-settings.tsx"),
