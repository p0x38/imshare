...
export const PERMALINK_ID_TYPES = [
    "normalizedTitle",
    "internalId",
    "creationDate",
    "custom",
...
export function permalinkBase(
    post: Pick<Post, "id" | "title" | "createdAt" | "customPostId">,
    idType: PermalinkIdType,
) {
    switch (idType) {
