...
export const postSchema = {
    type: "object",
    additionalProperties: false,
    required: ["id", "title", "description", "caption", "sourceUrl", "originalCreator", "originalCreatedAt", "allowDownload", "status", "visibility", "publishedAt", "scheduledAt", "hiddenAt", "contentWarning", "createdAt", "updatedAt", "author", "authorName", "viewCount", "category", "tags", "uploads", "reactions"],
    properties: {
        id: { type: "string" },
        title: { type: "string" },
        ...
        author: {
            ...
            properties: {
                ...
                updatedAt: dateTime, avatarUrl: { type: "string" },
            },
        },
        ...
        tags: {
            ...
            items: {
                ...
                properties: { id: { type: "string" }, name: { type: "string" }, slug: { type: "string" }, createdAt: dateTime, updatedAt: dateTime },
            },
        },
        uploads: {
            type: "array",
            items: {
                type: "object",
                additionalProperties: false,
                required: ["id", "filename", "originalName", "mimeType", "size", "createdAt", "thumbhash", "url"],
                properties: {
                    id: { type: "string" }, filename: { type: "string" }, originalName: { type: "string" }, mimeType: { type: "string" },
                    size: { type: "integer", minimum: 0 }, createdAt: dateTime,
                    thumbhash: { anyOf: [{ type: "string" }, { type: "null" }] }, url: { type: "string" },
                },
            },
        },
        reactions: {
            ...
            properties: {
                like: { type: "integer", minimum: 0 }, favorite: { type: "integer", minimum: 0 }, save: { type: "integer", minimum: 0 },
            },
        },
    },
} as const;
