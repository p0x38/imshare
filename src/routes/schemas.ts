...
export const userUpdateSchema = {
    body: {
        ...
        properties: {
            ...
            defaultContentWarning: { anyOf: [{ type: "string", maxLength: 500 }, { type: "null" }] },
        },
    },
} as const;
...
export const postCreateSchema = {
    body: {
        ...
        properties: {
            title: { type: "string", minLength: 1, maxLength: 500 }, ...contentProperties,
            description: { type: "string", maxLength: 10000 }, caption: { type: "string", maxLength: 10000 },
            sourceUrl: { type: "string", maxLength: 4096 }, ...originalPostProperties, ...permalinkProperties,
            allowDownload: { type: "boolean" }, ...postLifecycleProperties,
...
export const postUpdateSchema = {
    body: {
        ...
        properties: {
            ...
            allowDownload: { type: "boolean" }, sourceUrl: { anyOf: [{ type: "string", maxLength: 4096 }, { type: "null" }] },
            ...originalPostProperties, ...permalinkProperties,
            categoryId: { anyOf: [{ type: "string", minLength: 1 }, { type: "null" }] }, ...postLifecycleProperties,
            tags: { type: "array", maxItems: 100, items: { type: "string", minLength: 1, maxLength: 100 } },
        },
    },
} as const;
export const postTagSchema = { body: { type: "object", additionalProperties: false, required: ["tagId"], properties: { tagId: { type: "string", minLength: 1 } } } } as const;
export const postCategorySchema = { body: { type: "object", additionalProperties: false, required: ["categoryId"], properties: { categoryId: { anyOf: [{ type: "string", minLength: 1 }, { type: "null" }] } } } } as const;
export const tagCreateSchema = { body: { type: "object", additionalProperties: false, required: ["name", "slug"], properties: { name: { type: "string", minLength: 1, maxLength: 100 }, slug: { type: "string", minLength: 1, maxLength: 100, pattern: "^[a-z0-9]+(?:-[a-z0-9]+)*$" } } } } as const;
export const tagUpdateSchema = { body: { type: "object", additionalProperties: false, minProperties: 1, properties: { name: { type: "string", minLength: 1, maxLength: 100 }, slug: { type: "string", minLength: 1, maxLength: 100, pattern: "^[a-z0-9]+(?:-[a-z0-9]+)*$" } } } } as const;
export const categoryCreateSchema = { body: { type: "object", additionalProperties: false, required: ["name", "slug"], properties: { name: { type: "string", minLength: 1, maxLength: 100 }, slug: { type: "string", minLength: 1, maxLength: 100, pattern: "^[a-z0-9]+(?:-[a-z0-9]+)*$" }, description: { type: "string", maxLength: 10000 } } } } as const;
export const categoryUpdateSchema = { body: { type: "object", additionalProperties: false, minProperties: 1, properties: { name: { type: "string", minLength: 1, maxLength: 100 }, slug: { type: "string", minLength: 1, maxLength: 100, pattern: "^[a-z0-9]+(?:-[a-z0-9]+)*$" } } } } as const;
