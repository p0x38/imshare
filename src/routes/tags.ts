...
const pagination = [
    ...
    parameter.query("search", { type: "string" }),
];
    ...
    fastify.get(
        "/v1/tags",
        {
            schema: openapi({
                tags: "Tags",
                summary: "List tags",
                description: "Returns tags with post counts and optional name search.",
                operationId: "listTags",
                parameters: pagination,
                security: [{}],
                responses: { "200": { description: "Paginated tag collection." } },
            }),
        },
        async (request) => {
    ...
    fastify.get(
        "/v1/tags/autocomplete",
        {
            schema: openapi({
                ...
                description: "Returns tags matching a short search term.",
                operationId: "autocompleteTags",
                parameters: [
                    parameter.query("q", { type: "string" }),
                ...
                security: [{}],
                responses: { "200": { description: "Matching tags." } },
            }),
        },
        async (request) => {
            const q = request.query as Record<string, unknown>;
    ...
    fastify.get(
        "/v1/tags/:tagId",
        {
            schema: openapi({
                tags: "Tags",
                summary: "Get a tag",
                description: "Returns a tag and its post count.",
                operationId: "getTag",
                parameters: [tagId],
                security: [{}],
                responses: {
        ...
        "/v1/tags/:tagId",
        {
            schema: {
                ...
                ...openapi({
                    ...
                    description: "Updates a tag using the supplied fields.",
    ...
    fastify.get(
        "/v1/tags/:tagId/posts",
        {
            schema: openapi({
                ...
                description: "Returns public posts associated with a tag.",
                operationId: "listTagPosts",
                parameters: [tagId, ...pagination.slice(0, 3)],
                security: [{}],
                responses: { "200": { description: "Paginated post collection." } },
            }),
        },
        async (request) => {
            const { tagId } = request.params as { tagId: string };
