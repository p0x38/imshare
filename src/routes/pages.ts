...
export const pageRoutes: FastifyPluginAsync = async (fastify) => {
    ...
    const redirects: Record<string, string> = {
        "/login": "/account/login/", "/signup": "/account/register/", "/account": "/account/", "/account/sessions": "/account/", "/notifications": "/account/notifications/", "/account/notifications": "/account/notifications/", "/account/profile": "/account/profile/", "/posts": "/posts/", "/posts/new": "/posts/new/", "/texts": "/texts/", "/texts/new": "/texts/new/", "/dashboard": "/dashboard/", "/dashboard/analytics": "/dashboard/analytics/", "/dashboard/posts": "/dashboard/posts/", "/dashboard/tags": "/dashboard/tags/", "/dashboard/categories": "/dashboard/categories/", "/dashboard/settings": "/dashboard/settings/", "/users": "/users/", "/tags": "/tags/", "/categories": "/categories/", "/search": "/search/", "/about": "/about/", "/faq": "/faq/", "/badges": "/badges/", "/github": "/github/", "/privacy": "/privacy/", "/terms": "/terms/", "/admin": "/admin/", "/admin/users": "/admin/users/", "/admin/posts": "/admin/posts/", "/admin/reports": "/admin/reports/", "/admin/logs": "/admin/logs/", "/admin/settings": "/admin/settings/", "/admin/analytics": "/admin/analytics/",
    };
    ...
    fastify.get("/dashboard/analytics/", render("dashboard-analytics", "dashboard-analytics-page")); fastify.get("/dashboard/tags/", render("taxonomy", "taxonomy-page", 'data-taxonomy="tags"')); fastify.get("/dashboard/categories/", render("taxonomy", "taxonomy-page", 'data-taxonomy="categories"')); fastify.get("/dashboard/settings/", render("settings", "settings-page"));
