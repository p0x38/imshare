...
export const pageRoutes: FastifyPluginAsync = async (fastify) => {
    ...
    fastify.get("/about/", render("staticPages", "static-pages", 'data-static-page="about"'));
    fastify.get("/faq/", render("faq", "faq-page"));
    fastify.get("/github/", render("staticPages", "static-pages", 'data-static-page="github"'));
    fastify.get("/github/commits", render("git-commits", "git-commits-page"));
    fastify.get("/github/commits/", render("git-commits", "git-commits-page"));
    fastify.get("/privacy/", render("staticPages", "static-pages", 'data-static-page="privacy"'));
    fastify.get("/terms/", render("staticPages", "static-pages", 'data-static-page="terms"'));
