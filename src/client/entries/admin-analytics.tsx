...
function AnalyticsPage() {
    ...
    useEffect(() => {
        void api<{ data: Analytics }>("/v1/admin/analytics?days=30")
    ...
    return (
        <AdminLayout
            title="Analytics"
            description="First-party instance analytics from imshare's own database."
        ...
        >
            ...
            {data ? (
                <Stack spacing={3}>
                        ...
                        <CardContent>
                            <Stack spacing={1.5}>
                                ...
                                {data.topPosts.length ? (
                                    ...
                                    <Typography color="text.secondary">
                                        No post views recorded in this period.
                                    </Typography>
                                )}
                            </Stack>
                        </CardContent>
                    ...
                    <Alert severity="info">
                        Anonymous visitors are not counted as unique viewers. View analytics use
                        post-view records already stored by imshare and do not add a separate
