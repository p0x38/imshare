...
function TwoFactorPage() {
    ...
    return <Page maxWidth="sm"><Card variant="outlined"><CardContent><Stack component="form" spacing={2} onSubmit={(event) => void verify(event)}>
        <Typography variant="h4" component="h1">Two-factor authentication</Typography>
        <Typography color="text.secondary">Enter the six-digit code from your authenticator app, or use a recovery code if you cannot access it.</Typography>
    ...
    </Stack></CardContent></Card></Page>;
}

const root = document.querySelector("#two-factor-page");
if (root) createRoot(root).render(<App><TwoFactorPage /></App>);
