            ...
            >
                ...
                <Stack direction="row" spacing={0.25} alignItems="center" sx={{ ml: "auto" }}>
                    <Tooltip title={modeLabel}>
                        <IconButton color="inherit" aria-label={modeLabel} onClick={toggle}>
                    ...
                    <Tooltip
                        title={
                            unreadNotifications > 0
                                ? t("nav.unreadNotifications", { count: unreadNotifications })
                                : t("nav.notifications")
                        }
                    >
                        <IconButton
                    ...
                    >
                        ...
                        {user?.handle ? (
                            <MenuItem
                                onClick={() => goTo(`/users/@${encodeURIComponent(user.handle!)}`)}
                            >
                                Profile
                            </MenuItem>
                        ) : null}
                ...
                <List sx={{ px: 1 }}>
                    ...
                    {canAccessAdmin ? (
                        <ListItemButton
                            ...
                            sx={{ minHeight: 48, borderRadius: 1.5 }}
                        >
                            <ListItemText primary={t("admin.administration")} />
                        </ListItemButton>
                    ) : null}
                </List>
            </Drawer>
