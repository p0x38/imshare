...
export async function buildApp() {
    ...
    const sendPage = (view: string) => async (_request: FastifyRequest, reply: FastifyReply) =>
        reply.view(view);
    app.get("/", sendPage("index.ejs"));
    app.get("/posts/", sendPage("posts/index.ejs"));
    app.get("/posts/:postId", sendPage("posts/view.ejs"));
    app.get("/users/", sendPage("users/index.ejs"));
    app.get("/users/:userId", sendPage("users/view.ejs"));
    app.get("/users/:userId/posts", sendPage("users/posts.ejs"));
    app.get("/tags/", sendPage("tags/index.ejs"));
    app.get("/tags/:tagId", sendPage("tags/view.ejs"));
    app.get("/tags/:tagId/posts", sendPage("tags/posts.ejs"));
    app.get("/categories/", sendPage("categories/index.ejs"));
    app.get("/categories/:categoryId", sendPage("categories/view.ejs"));
    app.get("/categories/:categoryId/posts", sendPage("categories/posts.ejs"));
    app.get("/search/", sendPage("search/index.ejs"));
    app.get("/account/", sendPage("account/index.ejs"));
    app.get("/account/login/", sendPage("account/login/index.ejs"));
    app.get("/account/register/", sendPage("account/register/index.ejs"));
    app.get("/notifications/", sendPage("account/notifications.ejs"));
    app.get("/account/profile/", sendPage("account/profile.ejs"));
    ...
    app.get("/dashboard/tags/", sendPage("dashboard/tags.ejs"));
    app.get("/dashboard/categories/", sendPage("dashboard/categories.ejs"));
    app.get("/dashboard/settings/", sendPage("dashboard/settings.ejs"));
    app.get("/about/", sendPage("about.ejs"));
    app.get("/faq/", sendPage("faq.ejs"));
    app.get("/github/", sendPage("github.ejs"));
    app.get("/privacy/", sendPage("privacy.ejs"));
    app.get("/terms/", sendPage("terms.ejs"));
